...
int main(){
    ...
    //TEST CASES for TESTING ISIDENTICAL FUNCTION
    Node* a = new Node(1);
    a->left = new Node(2);
    a->right = new Node(3);
    ...
    cout << isIdentical(a, b) << endl;  // should print 1 (true)

    cout << isSubTree(a,b) << endl;

    b->right->data = 4;

    cout << isIdentical(a, b) << endl;  // should print 0 (false)
